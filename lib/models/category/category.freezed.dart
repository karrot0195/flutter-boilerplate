...
abstract class $CategoryCopyWith<$Res> {
  ...
  $Res call({String name, String imageUrl, String descr});
}
...
class _$_Category implements _Category {
  const _$_Category(
      {required this.name, required this.imageUrl, required this.descr});
  ...
  @override
  String toString() {
    return 'Category(name: $name, imageUrl: $imageUrl, descr: $descr)';
  }
...
abstract class _Category implements Category {
  const factory _Category(
      ...
      required final String descr}) = _$_Category;
